"""
Django settings for hono project.
...
SECRET_KEY = 'django-insecure-7$^(=1j-cj6xt)6*@f)zfzk_rbu2zk+!gocny0!uhw1-z78nl)'
...
]   #Part- 1 Configuring django-allauth
...
WSGI_APPLICATION = 'hono.wsgi.application'
